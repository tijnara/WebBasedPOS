          ...
          {articles.map(article => {
            ...
            return (
              <Link 
                key={article.href} 
                href={article.href} 
                className="group block bg-white/50 backdrop-blur-sm p-7 rounded-2xl shadow-md border border-white/30 hover:border-green-200 hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
