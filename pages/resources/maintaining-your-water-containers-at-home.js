...
export default function MaintainingContainers() {
  return (
      <>
        <style>{`
        .responsive-bg {
          background-image: url('/maintaining-your-water-containers-at-homemob.png');
        }
        @media (min-width: 768px) {
          .responsive-bg {
            background-image: url('/maintaining-your-water-containers-at-home.png');
          }
        }
      `}</style>
          ...
          <main className="max-w-4xl mx-auto px-6 py-12 md:py-20">
            ...
            >
              ...
              <div className="space-y-8 text-slate-700 leading-relaxed text-lg">
                ...
                <div className="bg-blue-50/50 p-6 rounded-2xl my-8 backdrop-blur-sm">
