...
export default function PurifiedIceForBusiness() {
  return (
      <>
        <style>{`
        .responsive-bg {
          background-image: url('/purified-ice-why-it-is-safer-for-your-businessmob.png');
        }
        @media (min-width: 768px) {
          .responsive-bg {
            background-image: url('/purified-ice-why-it-is-safer-for-your-business.png');
          }
        }
      `}</style>
          ...
          <main className="max-w-4xl mx-auto px-6 py-12 md:py-20">
            ...
            >
              ...
              <div className="space-y-8 text-slate-700 leading-relaxed text-lg">
                ...
                <div className="bg-slate-50/50 p-6 rounded-2xl my-8 flex flex-col md:flex-row items-start gap-6 backdrop-blur-sm">
                ...
                <div className="flex items-center p-4 bg-blue-50/50 rounded-xl mt-8 backdrop-blur-sm">
