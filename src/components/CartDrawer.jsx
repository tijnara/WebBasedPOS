...
const CartDrawer = ({
    ...
    return (
        <Dialog
            ...
            // Important: 'items-end' aligns modal to bottom, 'p-0' removes default padding to allow full width
            className="md:hidden items-end p-0"
        >
            <DialogContent
                className="w-full max-w-full rounded-t-2xl rounded-b-none border-0 shadow-2xl flex flex-col p-0 gap-0 bg-white"
                style={{
                    position: 'fixed',
                    bottom: 0,
                    left: 0,
                    ...
                    maxHeight: '85dvh', // Use dynamic viewport height
                    height: 'auto',
                    margin: 0,
                    zIndex: 50
                }}
            >
                ...
                {/* 'flex-1' allows this area to grow/shrink, 'overflow-y-auto' handles scrolling */}
                <div className="flex-1 overflow-y-auto w-full p-4" style={{ minHeight: '150px' }}>
                    {cartItems.length === 0 ? (
                        <div className="flex flex-col items-center justify-center h-full py-8 text-gray-500 space-y-2">
                                ...
                                <div key={key} className="flex items-center gap-3 py-3">
                                    ...
                                    <div className="flex-shrink-0 w-14 h-14 rounded-lg flex items-center justify-center overflow-hidden border border-gray-100 bg-gray-50">
                                        <ProductImage
                                            ...
                                            style={{ width: '100%', height: '100%', objectFit: 'cover', border: 'none', padding: 0 }}
                                        />
                                    </div>

                                    {/* Name & Price */}
                                    <div className="flex-1 min-w-0">
                                        <div className="font-semibold text-sm text-gray-900 leading-tight mb-1 truncate">{item.name}</div>
                                    ...
                                    <div className="flex flex-col items-end gap-2">
                                        ...
                                        <div className="flex items-center gap-2">
                                            <div className="flex items-center border border-gray-200 rounded-lg h-7 bg-white shadow-sm">
                                                ...
                                                <span className="min-w-[24px] text-center font-medium text-xs border-x border-gray-100 h-full flex items-center justify-center bg-gray-50">
                                                    {item.quantity}
                                                </span>
                                                <button
