        ...
        >
            <div className="px-6 mt-16 md:mt-24 relative z-20">
                <div className="max-w-3xl">
                    ...
                    <p className="mb-8 text-base md:text-lg text-slate-800 max-w-2xl font-medium leading-relaxed p-5 rounded-xl border shadow-sm bg-white/50">
                    ...
                    <ul className="mb-10 space-y-4 text-sm md:text-base font-medium text-slate-800 p-4 rounded-xl border shadow-sm inline-block bg-white/50">
