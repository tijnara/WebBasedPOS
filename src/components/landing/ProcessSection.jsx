...
export function Process() {
    ...
    return (
        ...
        <section id="process" className="py-16 md:py-24 bg-white relative overflow-hidden font-sans responsive-page">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="text-center mb-16 md:mb-24">
                    {/* FIXED FONT SIZES: Changed from the broken 10rem to proper responsive sizing */}
                    <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold text-[#0f172a] mb-6 tracking-tight leading-none drop-shadow-sm">
                        OUR <span style={{
                    ...
                    <p className="text-lg md:text-xl lg:text-[22px] text-gray-500 max-w-3xl mx-auto font-light leading-relaxed px-4">
                        From source to your jug, every step is designed to deliver the cleanest, healthiest water possible.
                    </p>
                </div>

                {/* Cards Container: added pb-8 so the hover shadows don't clip on mobile */}
                <div className="flex overflow-x-auto pb-8 snap-x snap-mandatory gap-6 md:grid md:grid-cols-2 lg:grid-cols-4 md:overflow-visible md:pb-0 mb-16">
                    {steps.map((step, index) => {
                        ...
                        return (
                            <div
                                key={index}
                                // FIXED CARD WIDTH: Mobile now takes up 85vw instead of squeezing
                                className="w-[85vw] sm:w-[320px] md:w-auto snap-center shrink-0 group bg-white p-6 md:p-8 rounded-[2rem] flex flex-col items-center text-center shadow-[0_4px_20px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_rgba(20,184,166,0.15)] transition-all duration-500 border border-gray-100 hover:border-teal-200 relative"
                            >
                                ...
                                <motion.div
                                    className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-white flex items-center justify-center mb-6 z-10"
                                    style={{
                                ...
                                >
                                    <div className="transform scale-100 md:scale-110 drop-shadow-md">
                                        <Icon gradId={gradId} />
                                    </div>
                                </motion.div>

                                <h3 className="text-lg md:text-[1.1rem] font-bold text-gray-900 mb-3 md:mb-4 group-hover:text-teal-600 transition-colors">
                                    {step.title}
                                </h3>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 bg-white/50 backdrop-blur-sm p-6 md:p-8 rounded-3xl border border-gray-100 shadow-sm">
                    <div className="text-center">
                        <div className="text-4xl md:text-[2.5rem] font-extrabold text-[#009b70] mb-1">21</div>
                        <div className="text-gray-500 text-xs md:text-sm font-medium tracking-wide">Filtration Stages</div>
                    </div>
                    <div className="text-center">
                        <div className="text-4xl md:text-[2.5rem] font-extrabold text-[#009b70] mb-1">99.9%</div>
                        <div className="text-gray-500 text-xs md:text-sm font-medium tracking-wide">Purity Rate</div>
                    </div>
                    <div className="text-center">
                        <div className="text-4xl md:text-[2.5rem] font-extrabold text-[#009b70] mb-1">24/7</div>
                        <div className="text-gray-500 text-xs md:text-sm font-medium tracking-wide">Quality Monitoring</div>
                    </div>
                    <div className="text-center">
                        <div className="text-4xl md:text-[2.5rem] font-extrabold text-[#009b70] mb-1">100%</div>
                        <div className="text-gray-500 text-xs md:text-sm font-medium tracking-wide">Customer Satisfaction</div>
                    </div>
                </div>
