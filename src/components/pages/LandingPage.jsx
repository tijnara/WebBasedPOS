    ...
    return (
        <div className="relative min-h-screen w-full font-sans text-slate-800">
            ...
            <div className="relative z-10 min-h-screen flex flex-col">
                ...
                {/* --- MAIN LAYOUT WRAPPER WITH SIDE BARS --- */}
                <div className="w-full max-w-[1400px] mx-auto flex justify-center items-start gap-6 px-2 lg:px-4 mt-4">
                    
                    {/* LEFT SIDE AD (Hidden on mobile/tablet, visible on extra-large desktop screens) */}
                    {!user && (
                        <div className="hidden xl:block w-[160px] sticky top-28 shrink-0">
                            <span className="text-[9px] text-gray-400 uppercase tracking-widest mb-1 block text-center">Advertisement</span>
                            <AdsterraVerticalBanner />
                        </div>
                    )}

                    {/* YOUR EXISTING MAIN CONTENT BOX */}
                    <div className="container mx-auto flex flex-col flex-grow relative backdrop-blur-sm shadow-lg border border-white/20 w-full max-w-6xl rounded-t-3xl" style={{ backgroundColor: '#FFFFFF80' }}>
                    ...
                    </div> {/* <-- This closes your main white box */}

                    {/* RIGHT SIDE AD (Hidden on mobile/tablet, visible on extra-large desktop screens) */}
                    {!user && (
                        <div className="hidden xl:block w-[160px] sticky top-28 shrink-0">
                            <span className="text-[9px] text-gray-400 uppercase tracking-widest mb-1 block text-center">Advertisement</span>
                            <AdsterraVerticalBanner />
                ...
                </div> {/* <-- THIS NEW DIV CLOSES THE MAIN LAYOUT WRAPPER */}
            </div>
