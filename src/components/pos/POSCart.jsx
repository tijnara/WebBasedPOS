                            ...
                            <div className="flex flex-col divide-y divide-gray-100 p-2">
                                {Object.entries(currentSale).map(([key, item]) => (
                                    <div key={key} className="flex items-center gap-2 py-2">
                                        {/* Image Container: Further reduced to w-6 h-6 (24px), removed gray background */}
                                        <div className="flex-shrink-0 w-6 h-6 rounded-md flex items-center justify-center overflow-hidden border border-gray-200">
                                            <ProductImage
