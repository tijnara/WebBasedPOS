...
export default function WhySeasideTrusted() {
    return (
        <>
            <style>{`
        .responsive-bg {
          background-image: url('/why-seaside-is-the-trusted-water-delivery-in-labradormob.png');
        }
        @media (min-width: 768px) {
          .responsive-bg {
            background-image: url('/why-seaside-is-the-trusted-water-delivery-in-labrador.png');
          }
        }
      `}</style>
                ...
                <main className="max-w-4xl mx-auto px-6 py-12 md:py-20">
                    ...
                    >
                        ...
                        <div className="space-y-8 text-slate-700 leading-relaxed text-lg">
                            ...
                            <div className="bg-green-50/50 p-6 rounded-2xl my-8 flex flex-col md:flex-row items-center gap-6 backdrop-blur-sm">
                            ...
                            <div className="bg-yellow-50/50 p-6 rounded-2xl my-8 backdrop-blur-sm">
