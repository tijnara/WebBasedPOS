...
export default function DispenserCleaningSigns() {
  return (
      <>
        <style>{`
        .responsive-bg {
          background-image: url('/signs-your-home-water-dispenser-needs-cleaningmob.png');
        }
        @media (min-width: 768px) {
          .responsive-bg {
            background-image: url('/signs-your-home-water-dispenser-needs-cleaning.png');
          }
        }
      `}</style>
          ...
          <main className="max-w-4xl mx-auto px-6 py-12 md:py-20">
            ...
            >
              ...
              <div className="space-y-8 text-slate-700 leading-relaxed text-lg">
                ...
                <div className="flex items-center p-4 bg-green-50/50 rounded-xl mt-8 backdrop-blur-sm">
