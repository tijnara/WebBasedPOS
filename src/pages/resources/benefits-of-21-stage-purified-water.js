...
export default function BenefitsOf21StageWater() {
  return (
      <>
        <style>{`
        .responsive-bg {
          background-image: url('/benefits-of-21-stage-purified-watermob.png');
        }
        @media (min-width: 768px) {
          .responsive-bg {
            background-image: url('/benefits-of-21-stage-purified-water.png');
          }
        }
      `}</style>
          ...
          <main className="max-w-4xl mx-auto px-6 py-12 md:py-20">
            ...
            >
              ...
              <div className="space-y-8 text-slate-700 leading-relaxed text-lg">
                ...
                <div className="bg-lime-50/50 p-6 rounded-2xl my-8 backdrop-blur-sm">
